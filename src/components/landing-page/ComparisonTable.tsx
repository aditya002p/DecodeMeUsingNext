    ...
    >
      ...
      <div className="relative z-10">
        ...
        >
          ...
          >
            <div className="py-2 lg:py-3 px-2 lg:px-4 text-left border-r border-[rgba(253,216,73,0.2)]">
              Factors
            </div>
            <div className="py-2 lg:py-3 px-2 lg:px-4 border-r border-[rgba(253,216,73,0.2)]">
              Decoding Me
            </div>
            <div className="py-2 lg:py-3 px-2 lg:px-4">Other Career Counselors</div>
          </div>
          ...
          {comparisonData.map((item, index) => (
            ...
            >
              <div className="p-2 lg:p-4 text-xs lg:text-sm border-r border-[rgba(253,216,73,0.2)]">
                {item.factor}
              </div>
              <div className="p-2 lg:p-4 text-xs lg:text-sm border-r border-[rgba(253,216,73,0.2)]">
                {renderDecodingApproach(item.decodingApproach)}
              </div>
              <div className="p-2 lg:p-4 text-xs lg:text-sm">{item.otherCounselors}</div>
            </div>
          ))}
        </div>
